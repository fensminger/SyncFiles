...
import org.swiftexplorer.swift.operations.LargeObjectManager;
import org.swiftexplorer.swift.operations.ProgressInformation;
...
public class SwiftOperations {

//    private static final int MAX_PAGE_SIZE = 9999;
//
//    final Logger logger = LoggerFactory.getLogger(SwiftOperations.class);
//
...
//     * {@inheritDoc}.
//     */
//	public synchronized void login(AccountConfig accConf) {
//		this.login(accConf, null, null);
//	}
//
//
//    /**
//     * {@inheritDoc}.
//     */
//	public synchronized void login(AccountConfig accConf, HasProxySettings proxySettings) {
//
//		this.login(accConf, null, proxySettings);
//	}
//
//
//    /**
//     * {@inheritDoc}.
//     */
//	public synchronized void login(AccountConfig accConf, HasSwiftSettings swiftSettings) {
//
//		this.login(accConf, swiftSettings, null);
//	}
//
//
//    /**
//     * {@inheritDoc}.
//     */
//	public synchronized void login(AccountConfig accConf, HasSwiftSettings swiftSettings, HasProxySettings proxySettings) {
//
...
//     * {@inheritDoc}.
//     */
//    public synchronized void login(AccountConfig accConf, String url, String tenant, String user, String pass) {
//
//    	this.login(accConf, null, url, tenant, user, pass) ;
//    }
//
//
//    /**
//     * {@inheritDoc}.
//     */
//    public synchronized void login(AccountConfig accConf, HasSwiftSettings swiftSettings, String url, String tenant, String user, String pass) {
//
//		String preferredRegion = null ;
//		if (swiftSettings != null) {
//
...
//     * {@inheritDoc}.
//     */
//    public synchronized void createContainer(ContainerSpecification spec) {
//
//    	CheckAccount () ;
//
//        if (spec != null) {
...
//     * {@inheritDoc}.
//     */
//    public synchronized void deleteContainer(Container container) {
//
//    	CheckAccount () ;
//
...
//     * @throws IOException
//     */
//    public synchronized void downloadStoredObject(Container container, StoredObject storedObject, File target) throws IOException {
//
//    	CheckAccount () ;
//
...
//     */
//	@Override
//	public synchronized void downloadStoredObject(Container container, Collection<Pair<? extends StoredObject, ? extends File> > pairObjectFiles, boolean overwriteAll, StopRequester stopRequester) throws IOException
//	{
//		CheckAccount () ;
//
...
//
//
//    private void uploadObject (StoredObject storedObject, File file) throws IOException
//    {
...
//     * {@inheritDoc}.
//     */
//    public synchronized void emptyContainer(Container container) {
//
//    	CheckAccount () ;
//
//    	try
...
//     * {@inheritDoc}.
//     */
//    public synchronized void purgeContainer(Container container) {
//
//    	CheckAccount () ;
//
//        for (StoredObject so : eagerFetchStoredObjects(container))
...
//     * {@inheritDoc}.
//     */
//    public synchronized void refreshContainers() {
//
//    	CheckAccount () ;
//    }
//
...
//     * {@inheritDoc}.
//     */
//    public synchronized void refreshStoredObjects(Container container) {
//
//    	CheckAccount () ;
//
//        reloadContainer(container);
...
//
//
//    private void reloadContainer(Container container) {
//
//    	if (container == null)
...
//
//
//    private void removedObjectFromContainer(Container container, List<StoredObject> deletedObjects) {
//
//    	if (container == null)
//    		throw new AssertionError ("container cannot be null") ;
//
...
//
//
//    private void loadContainerDirectory(Container container, Directory parent)
//    {
//    	if (container == null)
//    		throw new AssertionError ("container cannot be null") ;
//
...
//     */
//    @Override
//    public synchronized void getMetadata(Container c) {
//
//    	CheckAccount () ;
//
//        c.getMetadata();
...
//     */
//    @Override
//    public synchronized void getMetadata(StoredObject obj) {
//
//    	CheckAccount () ;
//
//        obj.getMetadata();
...
//     */
//	@Override
//	public synchronized void findDifferences (Container container, StoredObject remote, File local, ResultCallback<Collection<Pair<? extends ComparisonItem, ? extends ComparisonItem> > > resultCallback, StopRequester stopRequester) throws IOException
//	{
//		CheckAccount () ;
//
...
//
//
//	private void findFilesDifferences (Container container, StoredObject remote, File local, ResultCallback<Collection<Pair<? extends ComparisonItem, ? extends ComparisonItem> > > resultCallback, StopRequester stopRequester) throws IOException
//	{
//		if (SwiftUtils.isDirectory(remote) || Files.isDirectory(Paths.get(local.getPath())))
...
//
//
//	private void findDirectoriesDifferences (Container container, StoredObject remote, File local, ResultCallback<Collection<Pair<? extends ComparisonItem, ? extends ComparisonItem> > > resultCallback, StopRequester stopRequester) throws IOException
//	{
//		if (!SwiftUtils.isDirectory(remote) || !Files.isDirectory(Paths.get(local.getPath())))
//			throw new IllegalArgumentException () ;
//
...
//     */
//	@Override
//	public synchronized void uploadDirectory(Container container, StoredObject parentObject, File directory, boolean overwriteAll, StopRequester stopRequester) throws IOException {
//
//		CheckAccount () ;
//
...
//     */
//	@Override
//	public synchronized void uploadFiles(Container container, StoredObject parentObject, File[] files, boolean overwriteAll, StopRequester stopRequester) throws IOException
//	{
//		CheckAccount () ;
//
...
//     */
//	@Override
//	public synchronized void uploadFiles(Container container, Collection<Pair<? extends StoredObject, ? extends File> > pairObjectFiles, boolean overwriteAll, StopRequester stopRequester) throws IOException
//	{
//		CheckAccount () ;
//
//		if (pairObjectFiles == null || pairObjectFiles.isEmpty())
...
//
//
//	private void uploadFile (StoredObject obj, File file, ProgressInformation progInfo, boolean overwriteAll) throws IOException
//	{
...
//     */
//	@Override
//	public synchronized void createDirectory(Container container, StoredObject parentObject, String directoryName)
//	{
//		CheckAccount () ;
//
...
//     */
//	@Override
//	public synchronized void deleteDirectory(Container container, StoredObject storedObject, StopRequester stopRequester) {
//
//		CheckAccount () ;
//
//    	if (!SwiftUtils.isDirectory(storedObject))
...
//
//
//	private boolean keepGoing (StopRequester stopRequester)
//	{
...
//
//
//	private void dealWithOutOfMemoryError (OutOfMemoryError ome, String functionName)
//	{
