...
//    public static AccountConfig getHubicAccountConfig (final SwiftAccess sa, final HubicOAuth20ServiceImpl service)
//    {
...
//        accConf.setAccessProvider (getHubicAccessProvider (sa, service)) ;
//        return accConf ;
//    }
//
//    public static AccountConfig getHubicAccountConfigNoDelimiter (final SwiftAccess sa, final HubicOAuth20ServiceImpl service)
//    {
//        AccountConfig accConf = new AccountConfig () ;
//        accConf.setDisableSslValidation(false);
//        accConf.setAuthenticationMethod(AuthenticationMethod.EXTERNAL);
...
//
//
//    private static AuthenticationMethod.AccessProvider getHubicAccessProvider (final SwiftAccess sa, HubicOAuth20ServiceImpl service)
//    {
//    	return new HubicAccessProvider(sa, service) ;
//    }
//
//
