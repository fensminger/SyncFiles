...
//     <li role="menuitem"><a [routerLink]="['/home']"><i class="fa ui-icon-line-weight"></i><span>Synchronization</span></a></li>
// <li role="menuitem"><a [routerLink]="['/detail']"><i class="fa ui-icon-mode-edit"></i><span>Add Synchronization</span></a></li>
// <li role="menuitem"><a [routerLink]="['/running']"><i class="material-icons">autorenew</i><span>Running</span></a></li>

    ngOnInit() {
        this.model = [
          {label: 'Dashboard', icon: 'dashboard', routerLink: ['/']},
          {label: 'Synchronization', icon: 'apps', routerLink: ['/home']},
          {label: 'Add Synchronization', icon: 'edit', routerLink: ['/detail']},
          {label: 'Running', icon: 'autorenew', routerLink: ['/running']},
            {
