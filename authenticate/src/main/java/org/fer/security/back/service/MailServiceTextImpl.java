...
public class MailServiceTextImpl implements MailService{
    ...
    public void sendEmail(final UserProfile targetUser, final String context, final String subject, final String text) {
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("Sending " + context + " message to:" + targetUser.getEmail() + ", subject:" + subject + ", body:" + text )  ;
        }
        else {
    ...
    public void sendChangedPasswordMail(final UserProfile targetUser) {
